...
if( ! class_exists( 'WoosterUpdateChecker' ) ) {

	class WoosterUpdateChecker{
        ...
        public function __construct()
        {
            ...
            $this->version       = '1.0.1';
            $this->cache_key     = 'wooster_updater';
        ...
        public function update($transient)
        {
            ...
            if ($remote && version_compare($this->version, $remote->version, '<') && version_compare($remote->requires, get_bloginfo('version'), '<=') && version_compare($remote->requires_php, PHP_VERSION, '<')) {
                ...
                // $response->plugin = plugin_basename(__FILE__); // misha-update-plugin/misha-update-plugin.php
